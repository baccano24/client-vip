<template>
  <div class="tb-edit glqg_con">
    ...
    >
        ...
        <template slot-scope="props">
          <el-form label-position="left" inline class="demo-table-expand">
            <el-form-item label="留言标题：">
              <span>
                我对您发布的
                <a href target="_blank" style="color:#ff5b58">{{ props.row.ptname }}</a>产品感兴趣！
              </span>
            </el-form-item>
      ...
      <el-table-column label="留言标题">
        <template slot-scope="scope">
          我对您发布的
          <a href target="_blank" style="color:#ff5b58">{{ scope.row.ptname }}</a>产品感兴趣！
        </template>
      </el-table-column>
      ...
      <el-table-column align="right" label="操作" width="260px">
        <template slot-scope="scope">
          <ul class="caozuo">
            ...
            <li
              @click="handleEdit(scope.$index, scope.row);goTo('/product/detail/id='+scope.row.com_id)"
            >
              查看详情
              <span>|</span>
            </li>
