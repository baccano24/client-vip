<template>
  <div class="tb-edit">
    ...
    <header>
      <ul>
        <li :style="table_cpxx">图片信息</li>
        <li>未通过图片</li>
        <li>待审核图片</li>
      </ul>
      <div class="search_wrap">
        <input class="search" v-model="search" placeholder="查找图片信息">
        <span>
    ...
    >
      ...
      <el-table-column prop="ptname" label="图片名称" width="230"></el-table-column>
      <el-table-column prop="com_id" label="图片排序" sortable>
      ...
      <el-table-column align="right" label="操作" width="380px">
        <template slot-scope="scope">
          <ul class="caozuo">
            ...
            <li @click="handleEdit(scope.$index, scope.row);goTo('/xcxx/xg/id='+scope.row.com_id)">
              修改
              <span>|</span>
            </li>
          </ul>
