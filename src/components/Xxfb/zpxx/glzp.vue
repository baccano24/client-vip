<template>
  <div class="tb-edit glqg_con">
    ...
    <header>
      <ul>
        <li :style="table_cpxx">招聘信息</li>
        <li>未通过招聘</li>
        <li>待审核招聘</li>
      </ul>
      <div class="search_wrap">
        <input class="search" v-model="search" placeholder="查找招聘信息">
        <span>
    ...
    >
      ...
      <el-table-column prop="resend" label="招聘重发"  width="100"></el-table-column>
      <el-table-column align="right" label="操作" width="260px">
        <template slot-scope="scope">
          <ul class="caozuo">
            ...
            <li @click="handleEdit(scope.$index, scope.row);goTo('/zpxx/xg/id='+scope.row.com_id)">
              修改
              <span>|</span>
            </li>
          </ul>
