<template>
  <div class="tb-edit glqg_con">
    ...
    <header>
      <ul>
        <li :style="table_cpxx">加盟信息</li>
        <li>未通过加盟</li>
        <li>待审核加盟</li>
      </ul>
      <div class="search_wrap">
        <input class="search" v-model="search" placeholder="查找加盟信息">
        <span>
    ...
    >
      ...
      <el-table-column prop="resend" label="加盟重发"  width="100"></el-table-column>
      <el-table-column align="right" label="操作" width="260px">
        <template slot-scope="scope">
          <ul class="caozuo">
            ...
            <li @click="handleEdit(scope.$index, scope.row);goTo('/jmxx/xg/id='+scope.row.com_id)">
              修改
              <span>|</span>
            </li>
          </ul>
