<template>
  <div class="tb-edit glqg_con">
    ...
    <header>
      <ul>
        <li :style="table_cpxx">企业信息</li>
        <li>未通过企业</li>
        <li>待审核企业</li>
      </ul>
      <div class="search_wrap">
        <input class="search" v-model="search" placeholder="查找企业信息">
        <span>
    ...
    >
      ...
      <el-table-column prop="ptname" label="新闻标题" width="230"></el-table-column>
      ...
      <el-table-column align="right" label="操作" width="260px">
        <template slot-scope="scope">
          <ul class="caozuo">
            ...
            <li @click="handleEdit(scope.$index, scope.row);goTo('/qyxx/xg/id='+scope.row.com_id)">
              修改
              <span>|</span>
            </li>
          </ul>
